  ...
  return {
    ...
    link: function(scope, element, attrs) {
      ...
      element.bind("click", function(e) {
        /* MAAS CHANGE */
        // Added target=blank as a condition to allow programmatic ability to open links in a new window
        if ((e.which == 1) && !e.ctrlKey && !e.metaKey && !e.shiftKey  && attrs.target !== '_blank') {
        /* End MAAS CHANGE */
